...
contract PetalWrapper {
    ...
    function stake(uint256 amount) public virtual {
        ...
        petal.safeTransferFrom(msg.sender, address(this), amount);
    }
    ...
    function withdraw(uint256 amount) public virtual {
        ...
        petal.safeTransfer(msg.sender, amount);
    }
}

contract Garden is PetalWrapper, ContractGuard {
    using SafeERC20 for IERC20;
    ...
    function getTulipPrice() external view returns (uint256) {
        return treasury.getTulipPrice();
    }
    ...
    function stake(uint256 amount) public override onlyOneBlock updateReward(msg.sender) {
        require(amount > 0, "Garden: Cannot stake 0");
        super.stake(amount);
    ...
    function withdraw(uint256 amount) public override onlyOneBlock masonExists updateReward(msg.sender) {
        require(amount > 0, "Garden: Cannot withdraw 0");
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        require(amount > 0, "Garden: Cannot allocate 0");
        require(totalSupply() > 0, "Garden: Cannot allocate when totalSupply is 0");
