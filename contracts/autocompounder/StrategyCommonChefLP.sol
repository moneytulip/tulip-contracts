...
contract StrategyCommonChefLP is StratManager, FeeManager, GasThrottler {
    ...
    constructor(
        address _want,       // pair token
        uint256 _poolId,     // _pid
        address _chef,       // PETAL REWARD POOL
        address _vault,      // vault address
        address _unirouter,  // v2router
        address _keeper,     // address to use as alternative owner.
        address _strategist, // user
        address _beefyFeeRecipient,  // DAO-token-holder
        address[] memory _outputToNativeRoute,  // PETAL to TULIP
        address[] memory _outputToLp0Route,     // [PETAL]
        address[] memory _outputToLp1Route      // [PETAL, TULIP]
